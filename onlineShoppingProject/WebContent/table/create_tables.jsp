...
<%
	try{
		...
		String q2 = "create table product(id int, name varchar(500), category varchar(200), price int, status varchar(100), quantity int)";
		...
		String q4  ="create table message(id int AUTO_INCREMENT, email varchar(100), subject varchar(200),body varchar(1000), PRIMARY KEY(id), Salutation varchar(100))";
